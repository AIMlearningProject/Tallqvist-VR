...
namespace Cubizer
{
    namespace Model
    {
        public class VOXModel
        {
            ...
            public static void CreateCubeMesh16x16(ref Vector3[] vertices, ref Vector3[] normals, ref Vector2[] uv, ref int[] triangles, ref Color32[] colors, ref int index, VOXVisiableFaces faces, Vector3 translate, Vector3 scale, uint palette, Color32 voxelColor)
            {
            ...
            public static void CreateCubeMesh16x16(VOXCruncher it, ref Vector3[] vertices, ref Vector3[] normals, ref Vector2[] uv, ref Color32[] colors, ref int[] triangles, ref int index, float scaling, Color32 voxelColor)
            {
                Vector3 pos;
                ...
                VOXModel.CreateCubeMesh16x16(ref vertices, ref normals, ref uv, ref triangles, ref colors, ref index, it.faces, pos, scale, (uint)it.material, voxelColor);
            }
        }
    }
}